...
class trajopt:
    def __init__(self,name,horizon,tf,maxIter,Model,Cost,Const,Scaling=None,type_discretization="foh",
    ...
    def cvxopt(self) :
        ...
        try : 
            ...
            self.prob.solve(verbose=False,solver=cvx.CLARABEL,warm_start=False)
